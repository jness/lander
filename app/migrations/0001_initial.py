# Generated by Django 5.0.5 on 2024-05-31 20:03
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Name of the ArticleBot", max_length=100
                    ),
                ),
                (
                    "system_text",
                    models.CharField(
                        help_text="The role the ai will take when generating content",
                        max_length=255,
                    ),
                ),
                (
                    "title_text_template",
                    models.CharField(
                        help_text="The template used when asking ai to generate title",
                        max_length=255,
                    ),
                ),
                (
                    "user_text_template",
                    models.CharField(
                        help_text="The template used when asking ai to generate content",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.JSONField(
                        default=list,
                        help_text="List of subjects/persons to select for content generation",
                    ),
                ),
                (
                    "actions",
                    models.JSONField(
                        default=list,
                        help_text="List of actions to select for content generation",
                    ),
                ),
                (
                    "things",
                    models.JSONField(
                        default=list,
                        help_text="List of things to select for content generation",
                    ),
                ),
                (
                    "places",
                    models.JSONField(
                        default=list,
                        help_text="List of places to select for content generation",
                    ),
                ),
